...
//	String url = "https://maps.google.com/?q="+ AllConstants.lat+","+ AllConstants.lng+"";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(xyz.com.CT_GUIDE.R.layout.mapview);
		con = this;
		mapprogress = (ProgressBar) findViewById(xyz.com.CT_GUIDE.R.id.MprogressBar);
	...
	private void updateWebView(String url) {
		...
		fweBview = (WebView) findViewById(xyz.com.CT_GUIDE.R.id.mapView);
