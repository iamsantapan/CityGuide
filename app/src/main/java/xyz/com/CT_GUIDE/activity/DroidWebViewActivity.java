...
public class DroidWebViewActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(xyz.com.CT_GUIDE.R.layout.webview);
		con = this;
		progressBar = (ProgressBar) findViewById(xyz.com.CT_GUIDE.R.id.progressBar12);
	...
	private void updateWebView(String url) {
		...
		fweBview = (WebView) findViewById(xyz.com.CT_GUIDE.R.id.fbwebView);
